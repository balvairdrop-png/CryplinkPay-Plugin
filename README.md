[<img src="https://res.cloudinary.com/diica7at6/image/upload/v1774226418/cryplink-logo-blue_w6el8p.png" width="300"/>](image.png)

# CrypLink Payment Gateway for WooCommerce
...
The CrypLink plugin extends WooCommerce, allowing you to get paid in crypto directly on your store, with a simple setup and no sign-ups required.
...
among many others, for a full list of the supported cryptocurrencies and tokens, check [this page](https://merchant.cryplink.xyz/cryptocurrency).

#### Auto-value conversion

CrypLink plugin will attempt to automatically convert the value you set on your store to the cryptocurrency your customer chose.
...
If you're using WooCommerce in a different currency not listed here and need support, please [contact us](https://merchant.cryplink.xyz/) via our live chat.

**Note:** CrypLink will not exchange your crypto for FIAT or other crypto, just convert the value

#### Why choose CrypLink?

CrypLink has no setup fees, no monthly fees, no hidden costs, and you don't even need to sign-up!
...
CrypLink has a low 1% fee on the transactions processed. No hidden costs.
For more info on our fees [click here](https://merchant.cryplink.xyz/cryptocurrency)
...
2. Search for 'CrypLink Payment Gateway for WooCommerce'
3. Click 'Install Now'
...
3. Select `woocommerce-cryplink.zip` from your computer
4. Click 'Install Now'
5. Activate the plugin in the Plugin dashboard

#### Using FTP

1. Download `woocommerce-cryplink.zip`
2. Extract the `woocommerce-cryplink` directory to your computer
3. Upload the `woocommerce-cryplink` directory to the `/wp-content/plugins/` directory
...
Yes, the minimums change according to the chosen cryptocurrency and can be checked [here](https://merchant.cryplink.xyz/cryptocurrency).
If the WooCommerce order total is below the chosen cryptocurrency's minimum, an error is raised to the user.

#### Where can I find more documentation on your service?

You can find more documentation about our service on our [get started](https://merchant.cryplink.xyz/) page, our [technical documentation](https://merchant.cryplink.xyz/) page or our [eCommerce](https://merchant.cryplink.xyz/) page.
If there's anything else you need that is not covered on those pages, please get in touch with us, we're here to help you!

#### Where can I get support?

The easiest and fastest way is via our live chat on our [website](https://merchant.cryplink.xyz/) or via our [contact form](https://merchant.cryplink.xyz/).

### Screenshots

1. The settings panel used to configure the gateway.
2. Normal checkout with CrypLink.
...
* New settings to add CrypLink's services fees to the checkout
